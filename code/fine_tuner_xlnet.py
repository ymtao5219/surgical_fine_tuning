import argparse
from transformers import XLNetForSequenceClassification, XLNetTokenizerFast, TrainingArguments, Trainer, AutoModelForMultipleChoice, AutoModelForQuestionAnswering
...
def main(args):
    ...
    # if task_name == "mrpc":
    #     # Update the tokenizer initialization
    #     tokenizer = XLNetTokenizerFast.from_pretrained(model_name, max_length=85)
    ...
    if args.few_shot:
        ...
        # data_loader = GlueDataloader(task_name, model_name, tokenizer=tokenizer)
